  ...
  switch (action.type) {
    ...
    case FILTER_BY_GENDER:
      ...
      if (action.payload === "men") {
        filterProduct = state.copyProducts.filter(
          (el) => el.gender[0] === "men"
        );
      }
      if (action.payload === "women") {
        filterProduct = state.copyProducts.filter(
          (el) => el.gender[0] === "women"
        );
      }
      if (action.payload === "youth") {
        filterProduct = state.copyProducts.filter(
          (el) => el.gender[0] === "youth"
        );
      }
    ...
    case FILTER_BRAND_NAME:
      ...
      if (action.payload === "Nike") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Nike"
        );
      }
      if (action.payload === "Vans") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Vans"
        );
      }
      if (action.payload === "Gucci") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Gucci"
        );
      }
      if (action.payload === "adidas") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "adidas"
        );
      }
      if (action.payload === "Champion") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Champion"
        );
      }
      if (action.payload === "Converse") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Converse"
        );
      }
      if (action.payload === "Air Jordan") {
        filterName = state.copyProducts.filter(
          (el) => el.brand_name === "Air Jordan"
        );
      }
      if (action.payload === "all") {
    ...
    case FILER_BY_CATEGORY:
      ...
      if (action.payload === "other") {
        filterCategory = state.copyProducts.filter(
          (el) => el.category[0] === "other"
        );
      }
      if (action.payload === "running") {
        filterCategory = state.copyProducts.filter(
          (el) => el.category[0] === "running"
        );
      }
      if (action.payload === "lifestyle") {
        filterCategory = state.copyProducts.filter(
          (el) => el.category[0] === "lifestyle"
        );
      }
      if (action.payload === "basketball") {
        filterCategory = state.copyProducts.filter(
          (el) => el.category[0] === "basketball"
        );
      }
      if (action.payload === "skateboarding") {
        filterCategory = state.copyProducts.filter(
          (el) => el.category[0] === "skateboarding"
        );
      }
      if (action.payload === "all") {
